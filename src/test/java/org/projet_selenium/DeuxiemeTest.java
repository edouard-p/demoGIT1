...
public class DeuxiemeTest {
	...
	public void testPageObject(){
		...
		PageMyAccount page_my_account = page_accueil.clickMyAccount(driver);
		page_my_account.verifPageMyAccount();
		page_my_account.choixLangue("japanese");
		page_my_account.choixAnimal("Reptiles");
		page_my_account.clickEnableMyList();
